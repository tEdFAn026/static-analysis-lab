...
public class ProgramDependenceGraph extends Analysis {
    ...
    public double computeTightness(){
        ...
        double allSlices = (double)inAllSlices.size();
        double cfgSize = (double) controlFlowGraph.getNodes().size();
        return allSlices/cfgSize;
    }
    ...
    public double computeOverlap(){
        ...
        double numSlices = (double) slices.size();
        return uniqueTotal/numSlices;
    }
}
